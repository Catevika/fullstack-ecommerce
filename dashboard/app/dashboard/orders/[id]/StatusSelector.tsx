...
const statuses = [{ label: 'New', value: 'New' }, { label: 'Paid', value: 'Paid' }, { label: 'Payment_failed', value: 'Payment failed' }, { label: 'Shipped', value: 'Shipped' }, { label: 'Delivered', value: 'Delivered' }];
